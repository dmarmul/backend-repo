...
VALUES
    ...
    (6,2,
     'Location',
     'Museumplein is situated in the South Amsterdam district, surrounded by key landmarks such as the Rijksmuseum, Van Gogh Museum, Stedelijk Museum, and the Concertgebouw. It is conveniently located close to Amsterdam''s famous Leidseplein and P.C. Hooftstraat, an upscale shopping street. The area is well-connected to the rest of the city via trams, buses, and is within walking distance to the Vondelpark.'),
    (7,2,
     'Cultural & Artistic Hub',
     'Living near Museumplein means being at the epicenter of Amsterdam''s cultural scene.'),
    (8,2,
     'Green Spaces',
     'The Museumplein itself is a large open square surrounded by lush greenery, ideal for outdoor activities, relaxing, or enjoying seasonal events. It is also close to Vondelpark, Amsterdam''s most famous park, perfect for jogging, cycling, or picnicking.'),
    (9,2,
     'Sophisticated Lifestyle',
     'Museumplein offers an unparalleled combination of cultural prestige, natural beauty, and high-end living. The area’s peaceful ambiance, luxurious properties, and proximity to green spaces and cultural landmarks create a perfect environment for those who appreciate a sophisticated lifestyle.'),
    (10,2,
     'Strong Rental Demand',
     'Due to its proximity to cultural landmarks, high-end shopping areas, and excellent public transportation, Museumplein is popular among expatriates, diplomats, and professionals. This makes it a prime location for both short-term and long-term rentals.'),
    (11,3,
     'Location',
    ...
    (22,5,
     'Vibrant Street Life',
     'Spui is a lively part of the city, with a mix of cafes, boutiques, galleries, and restaurants. The area is also home to several popular cafés and bars, many of which offer outdoor seating where locals and visitors enjoy the hustle and bustle of city life. The square regularly hosts events, performances, and markets, adding to its dynamic atmosphere.'),
    (23,5,
     'Green Spaces',
     'Although Spui itself is more urban in character, it is located near some of Amsterdam’s most iconic green spaces, such as: Vondelpark and Oosterpark.'),
    (24,5,
     'Community & Demographics',
     'The Spui area attracts a diverse range of residents, from young professionals and artists to families and expatriates. The combination of historical charm, cultural vibrancy, and central location makes it an ideal place for those seeking a balanced lifestyle in one of Amsterdam’s most iconic neighborhoods.'),
    (25,6,
     'Location',
    ...
    (65,15,
     'Location',
     'Rivierenbuurt is nestled in Amsterdam South, bordered by the Amstel River to the east and the Zuidas business district to the west. Its central location makes it highly desirable for those who want proximity to the city center but prefer a quieter, more residential environment.'),
    (66,15,
     'Green Spaces & Waterfront Living',
     'Rivierenbuurt is located close to several parks and green spaces, making it perfect for outdoor lovers: Amstelpar, Zuider Amstelkanaal, Oosterpark.'),
    (67,15,
     'Community & Demographics',
     'Rivierenbuurt attracts a mix of families, young professionals, and older residents, contributing to a balanced, peaceful atmosphere. The community values its green spaces, residential feel, and proximity to cultural and business districts.'),
    (68,15,
     'Peaceful & Family-Friendly',
     'Rivierenbuurt offers a calm, residential atmosphere, making it perfect for families and anyone who prefers a quieter environment without compromising on convenience. The neighborhood’s proximity to green spaces, schools, and parks adds to its appeal for those with children.'),
    (69,16,
     'Location',
     'Amsterdam Noord is located across the IJ River, accessible from the city center via ferry, which operates 24/7 and is free of charge. It is just a short ride from Amsterdam Centraal Station, making the area highly convenient for commuters.'),
    (70,16,
     'Creative & Cultural Hub',
     'Noord has developed into a hub for creativity and innovation, attracting artists, designers, and entrepreneurs.'),
    (71,16,
     'Green Spaces & Nature',
     'Despite its industrial roots, Noord boasts a significant amount of green space and natural surroundings.'),
    (72,16,
     'Community & Demographics',
     'Noord is an emerging neighborhood with a vibrant and diverse community, attracting both locals and expatriates. The area is popular with young professionals, creatives, and families looking for a quieter, more spacious alternative to the city center. With new developments on the rise, the neighborhood is becoming an increasingly desirable place to live.'),
    (73,17,
     'Location',
     'Westpoort is situated to the northwest of Amsterdam, bordered by the North Sea Canal and the A10 Ring Road, providing excellent access to the city center and beyond. The area is primarily known for its proximity to the Port of Amsterdam, one of the busiest ports in Europe, making it a key logistics and industrial area.'),
    (74,17,
     'Business & Logistics Hub',
     'As part of Amsterdam’s extensive logistical infrastructure, Westpoort is home to warehouses, distribution centers, and offices. The area’s connection to the North Sea Canal and Port of Amsterdam makes it a crucial part of the city’s trade and transport network, attracting businesses in logistics, shipping, and international trade.'),
    (75,17,
     'Green Spaces & Waterfront Living',
     'Westpoort is strategically located next to several green areas and waterfront spaces, making it attractive to those who appreciate access to nature in an otherwise industrial area.'),
    (76,17,
     'Community & Demographics',
     'Westpoort has historically been an industrial area, but as residential developments increase, the community is becoming more diverse. The area is attracting young professionals, entrepreneurs, and families who work in nearby businesses or prefer living in a less central but more affordable location. As the area continues to evolve, Westpoort is becoming increasingly attractive to those seeking space, convenience, and a mix of urban and industrial character.');